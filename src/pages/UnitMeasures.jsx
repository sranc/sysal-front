...
import UnitMeasureForm from "../components/forms/UnitMeasureForm";
import { FaTableList, FaWpforms } from "react-icons/fa6";
import useUnitMeasure from "../hooks/useUnitMeasure"; // Importa el hook
...
const UnitMeasures = () => {
  ...
  const handleUpdate = (form, resetForm) => {
    ...
    updateUnitMeasure.mutate(updatedForm, {
      onSuccess: () => {
        Swal.fire({
          position: "center",
          icon: "success",
  ...
  const handleDelete = (el) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteUnitMeasure.mutate(el.id, {
          onSuccess: () => {
            Swal.fire({
              position: "center",
              icon: "success",
