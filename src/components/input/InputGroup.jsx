...
const InputGroup = ({
  ...
  const inputClasses = `border-2 border-bdinput dark:border-graydark outline-none rounded-lg bg-bginput dark:bg-bgdarkinput px-4 pt-6 pb-2 z-10 text-sm focus:outline-none ${colorErrorCase(
    color
  )}`;
